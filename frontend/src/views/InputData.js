...
export default function InputData() {
  ...
  const [capital_loss, setCapital_loss] = useState("");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>성능 개선에 참여해주세요</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.center} >
         <View>
                ...
                >
                    <Picker.Item label="" value="" />
                    <Picker.Item label="5천 이상" value="1" />
                    <Picker.Item label="5천 미만" value="0" />
                </Picker>
                </View>
                ...
                <Text
                    ...
                    if (
                        ...
                        String(age).length &&
                        String(hours).length &&
                        String(capital_gain).length &&
                        String(capital_loss).length &&
                        income.length
                    ) {
                        axios
                        .post(
                            SERVER.BASE_URL + "income/input/",
                            {
                            age: age,
